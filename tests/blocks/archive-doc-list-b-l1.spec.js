...
test("Archive Doc List B L1 - Snapshot", async ({ page }) => {
  await safeGoto(page, `${BASE_URL}/archive-doc-list-b-l1/`);
  const content = page.locator("main#content");
  await expect(content).toBeVisible({ timeout: 10000 });
  await expect(content).toMatchAriaSnapshot(`
    - main:
      - heading "Archive Doc List B L1" [level=1]
      ...
      - list:
        - listitem:
          - link "1":
            - /url: https://betteromation.shahrear.msf.bd/archive-doc-list-b-l1/page/1
        - listitem:
          - link "2":
            - /url: https://betteromation.shahrear.msf.bd/archive-doc-list-b-l1/page/2
        - listitem:
          - link "❯":
            - /url: https://betteromation.shahrear.msf.bd/archive-doc-list-b-l1/page/2
  `);
