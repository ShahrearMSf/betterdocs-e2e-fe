  ...
  await expect(content).toMatchAriaSnapshot(`
    - main:
      ...
      - list:
        - listitem:
          - link "1":
            - /url: https://betteromation.shahrear.msf.bd/archive-doc-list-b-l3/page/1
        - listitem:
          - link "2":
            - /url: https://betteromation.shahrear.msf.bd/archive-doc-list-b-l3/page/2
        - listitem:
          - link "3":
            - /url: https://betteromation.shahrear.msf.bd/archive-doc-list-b-l3/page/3
        - listitem:
          - link "4":
            - /url: https://betteromation.shahrear.msf.bd/archive-doc-list-b-l3/page/4
        - listitem:
          - link "❯":
            - /url: https://betteromation.shahrear.msf.bd/archive-doc-list-b-l3/page/2
  `);
