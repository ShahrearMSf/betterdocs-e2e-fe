...
test("Faq W Modern - Snapshot", async ({ page }) => {
  await safeGoto(page, `${BASE_URL}/faq-w-modern/`);
  const content = page.locator("main#content");
  await expect(content).toBeVisible({ timeout: 10000 });
  await expect(content).toMatchAriaSnapshot(`
    - main:
      - heading "FAQ W Modern" [level=1]
      - heading "Random Asked Questions" [level=1]
      ...
      - heading "Shipping & Delivery" [level=1]
      - list:
        - listitem:
        ...
        - listitem:
          ...
          - img
      - heading "Refund & Exchange" [level=1]
      - list:
        - listitem:
